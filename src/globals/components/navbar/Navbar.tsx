    ...
    >
      <div className=" container mx-auto flex flex-col gap-4 px-4 text-center sm:flex-row sm:items-center sm:justify-between sm:gap-0 lg:px-8 xl:max-w-7xl">
        <div>
          ...
          >
            <svg
              className="hi-mini hi-cube-transparent inline-block size-5 text-blue-600 transition group-hover:scale-110 dark:text-blue-700"
        ...
        <nav className="space-x-3 md:space-x-6">
          {!isLoggedIn ? (
            <>
              <Link
                to="/register"
                className="text-sm font-bold text-gray-900 hover:text-blue-600 dark:text-black-100 dark:hover:text-blue-400"
              >
                <span>Register</span>
              </Link>
              <Link
