...
const Hero = () => {
  return (
    <>
      <div className="relative overflow-hidden bg-white dark:bg-white-900 dark:text-gray-100">
        <Navbar />
          ...
          <div className="lg:flex lg:w-1/2 lg:items-center">
            <div>
             ...
             v6.0 Latest Version
              ...
              <h1 className="mb-4 text-4xl font-black text-black dark:text-black ">
                Next generation {""}
                <span className="text-blue-600 dark:text-blue-500">
                  website builder
                </span>
              </h1>
              <h2 className="text-xl font-medium leading-relaxed text-gray-700 dark:text-black-300">
              ...
              <div className="flex flex-col justify-center gap-2 pb-16 pt-10 sm:flex-row sm:items-center lg:justify-start">
                ...
                <a
                  href="#"
                  className="inline-flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-7 py-3.5 font-semibold leading-6 text-gray-800 hover:border-gray-300 hover:text-gray-900 hover:shadow-sm focus:ring focus:ring-gray-300/25 active:border-gray-200 active:shadow-none dark:border-gray-700 dark:bg-transparent dark:text-black-300 dark:hover:border-gray-600 dark:hover:text-gray-200 dark:focus:ring-gray-600/40 dark:active:border-gray-700"
                >
